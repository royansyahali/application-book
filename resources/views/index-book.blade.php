      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="d-flex flex-row-reverse bd-highlight">
            @if (Auth::user()->role == "1")
              <a class="btn btn-primary ml-2 btn-sm" href="{{route("book.create")}}" role="button">Create</a>
            @endif
          </div>
        </div>
        <!-- /.card-header -->
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ucwords($item->categories->category)}}</td>
                <td>{{ucwords($item->authors->author)}}</td>
                <td>
                  <div class="d-flex justify-content-start">
                    <a href="{{route("book.edit",["id"=>$item->id])}}" class="btn mr-1 btn-sm btn-warning"><i class="fa fa-cog"></i></a>
